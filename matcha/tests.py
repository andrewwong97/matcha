...
#Untested
@raises(AttributeError)
def test_create_employer_profile_mismatch():
    ...
    assert em_test.company_name == 'company_name'
    assert em_test.description == 'DNE' # records do not match up
    assert em_test.num_employees == 0
    assert em_test.email == 'email'
    assert em_test.password == 'password'
    assert em_test.location == 'location'
...
#Untested
@raises(AttributeError)
def test_edit_employer_profile_mismatch():
    ...
    assert new_em_test.company_name == 'company_name'
    assert new_em_test.description == 'old_description' # records do not match up
